...
// @description up your alexa rank.v1.8.5 提高频率 | v1.8.1 减少各子域名 ，增加www出现次数。| 添加各子域名  add buychuan.com   submit so.com. v1.7.6:remove  90hao.com & 2133.com;v1.5.2:keyword add.&.delete.. v1.3.16 清除游戏链接    去除so.aliyun.com v1.3.14 去除zjmovie.net 修正百度form表单提交 v1.3.12 调整打开域名比例; v1.3.11 微调:sogou,aliyun的搜索结果 
...
(function() {
	...
	function findLink(){
		...
		var tempHref,addonA;
		var mylength = 60;
		//var preStr = ["ysbb","zgdy","dmdj","xxys","zyyl","dmyx","ssbb","dsj","dmbb","jlp","dqyg","pfph","wgdy","ylbb","mhmh","yp","gykj","blog","dm"];
